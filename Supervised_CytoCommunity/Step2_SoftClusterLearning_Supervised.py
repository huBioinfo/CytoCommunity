...
# Hyperparameters
max_nodes = 3800   #This number must be higher than the largest number of cells in each image in the studied dataset.
beta = 0.9
Num_TCN = 10
Num_Epoch = 50
Num_Dimension = 128
...
for num_time in range(1, 11):  #10 times of k-fold cross-validation.
    ...
    n = (len(dataset) + 9) // 10   #10-fold cross-validation.
    start_point = 0
